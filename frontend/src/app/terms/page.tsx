...
import { TERMS_SECTIONS, TERMS_META, type TermBlock } from '@/lib/terms-data';
    ...
    <div className="min-h-screen bg-black text-white font-mono selection:bg-white selection:text-black">
      ...
      >
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            Please read these terms carefully before using EventTicket. By accessing our Services, you
          ...
          >
            <span className="flex items-center gap-2 text-mono-light-grey uppercase tracking-widest">
              ...
              Last Updated: <span className="text-white font-bold">{TERMS_META.lastUpdated}</span>
            </span>
            <span className="flex items-center gap-2 text-mono-light-grey uppercase tracking-widest">
              Effective Date: <span className="text-white font-bold">{TERMS_META.effectiveDate}</span>
            </span>
          </motion.div>
        </div>
      </motion.section>
      ...
      {/* Body: TOC + Content */}
      <section className="py-10 md:py-14" aria-label="Terms of Service content">
        <div className="container mx-auto px-4 md:px-6">
              ...
              <div className="max-w-3xl">
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      {section.body.map((block, i) => (
                        <TermBlockRenderer key={i} block={block} />
                      ))}
                    </div>
                  </motion.article>
                ))}
                ...
                >
                  ...
                  <p className="text-sm text-[#CCCCCC] mb-4">
                    If anything in these Terms is unclear, our support team is here to help.
                  </p>
...
function TermBlockRenderer({ block }: { block: TermBlock }) {
  switch (block.type) {
    case 'paragraph':

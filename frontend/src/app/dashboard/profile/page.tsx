          ...
          <div className="bg-black border border-mono-dark-grey p-6">
            <div className="flex items-center gap-6">
              <div className="relative">
                ...
                <button className="absolute bottom-0 right-0 w-8 h-8 bg-white border-2 border-black rounded-full flex items-center justify-center hover:bg-[#CCCCCC] transition-colors" aria-label="Upload profile image">

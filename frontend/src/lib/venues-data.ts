...
export const VENUES: Venue[] = [
  ...
  {
    id: 'ven-4',
    slug: 'studio-pelni-kemayoran',
    name: 'Studio Pelni',
    type: 'theater',
    shortDescription: 'Intimate proscenium theater perfect for theatre, jazz, and acoustic performances.',
    description:
      'Studio Pelni is a 1,200-seat proscenium theater located in Kemayoran. Designed by acclaimed acoustician Yasuhisa Toyota, the venue features one of the best natural acoustics in Indonesia. Ideal for classical concerts, theatre productions, and intimate solo performances.',
    city: 'Jakarta',
    address: 'Jl. Lodan Raya, Ancar',
    province: 'DKI Jakarta',
    postalCode: '14420',
    capacity: { seated: 1200, standing: 0, total: 1200 },
    facilities: ['Car', 'Accessibility', 'Coffee', 'CreditCard', 'Shield', 'Wind', 'DoorOpen', 'Music'],
    images: [
      {
        url: 'https://images.unsplash.com/photo-1507676184212-d03ab07a01bf?q=80&w=2000&auto=format&fit=crop',
        alt: 'Elegant theater interior with red seats and ornate ceiling',
        caption: 'Main hall',
      },
    ],
    geo: { lat: -6.1442, lng: 106.8378 },
    contact: {
      phone: '+62 21 6684 1234',
      email: 'info@studiopelni.id',
      website: 'https://www.studiopelni.id',
    },
    rating: 4.8,
    reviewCount: 423,
    ...
    isAccessible: true,
    parkingSpots: 400,
    publicTransport: ['Kemayoran Busway', 'Pasar Baru Busway'],
    established: 1994,
  },
  {
    id: 'ven-5',
